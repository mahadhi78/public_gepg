...
!(function (o) {
  (o.illBeBack = function (t, n) {
    function i() {
      var t = {
        ...
        n = {
          ...
          WebkitTransition:
            "background-color " + r.options.hoverDuration + "ms linear",
          MozTransition:
            "background-color " + r.options.hoverDuration + "ms linear",
          MsTransition:
            "background-color " + r.options.hoverDuration + "ms linear",
    ...
    function e() {
      o(window).bind("scroll", function () {
        ...
        t > r.options.offset
          ? r.target.fadeIn(r.options.duration)
          : r.target.fadeOut(r.options.duration);
      }),
        r.target.bind("mouseenter", function () {
          r.target.css({ "background-color": r.options.hoverBgColor });
        }),
        r.target.bind("mouseleave", function () {
          r.target.css({ "background-color": r.options.bgColor });
        }),
        r.target.bind("click", function (t) {
          t.preventDefault(),
            o("html, body").animate({ scrollTop: 0 }, r.options.speed);
        });
    }
    var r = this;
    (r.target = o(t)),
      (r.init = function () {
        (r.options = o.extend({}, o.illBeBack.defaultOptions, n)),
  ...
  color:"#fff",
      ...
      bgSize: "50%",
      bgRepeat: "no-repeat",
      bgImage: "url(../assets/icons/angle-up.svg)",
    }),
